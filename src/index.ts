...
const tools = {
  ...
  align: {
    description: 'Align shapes by edge or center on one axis. axis: left/right/top/bottom/center-x/center-y.',
    schema: alignSchema,
    handler: align,
  },
  distribute: {
    description: 'Evenly space shapes between the outermost two on the given axis. Need at least 3 shapes.',
